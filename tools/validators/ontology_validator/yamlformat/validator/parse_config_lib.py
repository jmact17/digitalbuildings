...
def ParseTypeFoldersFromFiles(types_files, field_universe=None, guid_required=True):
  ...
  def CreateEntityTypeFolder(folderpath, parent_namespace):
    ...
    return entity_type_lib.EntityTypeFolder(folderpath, field_universe, guid_required)
